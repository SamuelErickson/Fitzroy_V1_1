...
#FAN POWER ARGUMENT DOESN'T WORK - switched for PID control

os.system("screen -d -m -S environmental_control bash -c \"python3 run_environmental_control.py 25 70 0 8 30 12 0 \"")
